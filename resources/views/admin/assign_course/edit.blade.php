                                    ...
                                    <div class="form-group @if($errors->has('course_id')) has-error @endif">
                                        ...
                                        <select class="form-control"  name="course_id">
                                            ...
                                            @foreach($courses as $course)
                                                <option {{ $assign_course->course_id == $course->id ? 'selected' : '' }} value={{ $course->id }} {{ old($course->id) }}> {{ $course->course_code." | ".$course->course_name. " | "  }} {{ $course->course_type == 0 ? 'Theory' : 'Sessional' }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group @if($errors->has('batch_id')) has-error @endif">
                                        ...
                                        <select  name="batch_id" id="" class="form-control">
                                            ...
                                            @foreach($batches as $batch)
                                                <option {{ $assign_course->batch_id == $batch->id ? 'selected' : '' }} value={{ $batch->id }} {{ old($batch->id) }}> {{ $batch->department->department_name. '-' . $batch->batch_no. '-' . $batch->shift->slug}}</option>
                                            @endforeach
                                        </select>
